...
export const departments: Department[] = [
  ...
  },
  {
    ...
    type: "list",
    services: [
      { name: "بدكير ومانيكير", price: "10 دينار" },
      { name: "بدكير ومانيكير مع لون", price: "12 دينار" },
      { name: "جلسة علاجية للقدم", price: "10 دينار" },
      { name: "جل كلر — يدين أو قدمين شامل التنظيف الكامل", price: "15 دينار" },
      { name: "سوفت جل", price: "25 دينار" },
      { name: "تركيب أسبوعي مع جل", price: "15 دينار" },
      { name: "تركيب شهري مع جل", price: "18 دينار" },
      { name: "إزالة الجل", price: "5 دينار" },
      { name: "التنظيف", price: "5 دينار" },
    ]
  }
];
